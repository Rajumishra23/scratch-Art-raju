  ...
  return (
    <header className="bg-black text-white sticky top-0 z-50 shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        {/* Static Logo */}
        <Link to="/" className="text-2xl font-bold tracking-wide text-white font-serif">
          Scratch Art
        </Link>
        ...
        <div className="flex items-center space-x-6">
            ...
            >
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  {item.subItems && (
                    <ul className="absolute hidden group-hover:block bg-gray-900 text-white p-4 rounded shadow-lg z-50 min-w-[200px] transition-all duration-300 transform origin-top scale-95 group-hover:scale-100 group-hover:opacity-100 opacity-0">
          ...
          <motion.div
            whileTap={{ scale: 0.9 }}
            className="md:hidden cursor-pointer hover:text-blue-400"
