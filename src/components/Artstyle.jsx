      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch px-4">
        ...
        >
          <img
            ...
            className="rounded-lg shadow-lg border border-gray-200 w-full h-full object-cover"
          />
        </motion.div>
        ...
        <motion.div
          ...
          className="h-full flex flex-col justify-between border border-blue-500 p-6 rounded-lg shadow-md bg-white"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-blue-600 text-white px-5 py-2 rounded hover:bg-blue-700 transition self-start"
          >
            READ MORE
          </motion.button>
        </motion.div>
