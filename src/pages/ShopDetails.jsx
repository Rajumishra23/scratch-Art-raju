...
const ShopDetails = () => {
  ...
  const { product } = location.state || {}; // ✅ removed unused allProducts
  const [mainImage, setMainImage] = useState(product?.image);

  if (!product) {
    return (
      <p className="text-center text-red-500 mt-10">
        No artwork data found!
      </p>
    );
  }

  // 👇 Repeat the same image 4 times for thumbnails
  const thumbnails = [
    product.image,
    product.image,
    product.image,
    ...
    <div className="p-6 max-w-6xl mx-auto overflow-x-hidden">
            ...
            <div className="flex gap-4 overflow-x-auto scrollbar-hide max-w-full">
              <div className="min-w-[220px] bg-yellow-50 border border-yellow-300 rounded-lg p-4 shadow-sm">
                ...
                <p className="text-sm text-gray-700">
                  Use Coupon Code <span className="font-bold">SHOP100</span>
                </p>
              </div>
              <div className="min-w-[220px] bg-green-50 border border-green-300 rounded-lg p-4 shadow-sm">
                ...
                <p className="text-sm text-gray-700">
                  Get <span className="font-bold">5% Instant Discount</span> on
                  Prepaid Orders
                </p>
              </div>
              <div className="min-w-[220px] bg-blue-50 border border-blue-300 rounded-lg p-4 shadow-sm">
                ...
                <p className="text-sm text-gray-700">
                  Flat <span className="font-bold">₹200 OFF</span> on orders
                  above ₹2000
                </p>
              </div>
            </div>
          ...
          <div className="mb-6 p-4 border border-gray-500 rounded-lg shadow-sm bg-gray-50">
            ...
            <ul className="text-sm text-gray-700 space-y-2">
              <li>
                ...
                <span className="font-semibold">Monday, 6 October</span>
              </li>
      ...
      <div className="mb-6 p-4 border border-gray-300 rounded-lg shadow-sm bg-gray-50">
        <h3 className="font-semibold text-gray-800 mb-4">
          FAQs: Find Your Answers Fast
        </h3>
        <ul className="space-y-3 text-sm text-gray-700">
          <li>
            <p className="font-semibold">❓ Are these hand paintings?</p>
            <p className="ml-4 text-gray-600">
              Yes, all our artworks are crafted with premium quality and
              attention to detail.
            </p>
          </li>
          <li>
            <p className="font-semibold">
              ❓ I need customisation. Can it be done?
            </p>
            <p className="ml-4 text-gray-600">
              Absolutely! We offer custom sizes and framing options on request.
            </p>
          </li>
          <li>
            <p className="font-semibold">❓ Do you have a return policy?</p>
            <p className="ml-4 text-gray-600">
              Yes, we provide easy 7-day returns and exchanges for all
              artworks.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p className="ml-4 text-gray-600">
              We are based in Delhi, and ship artworks pan-India with free
              delivery.
            </p>
          </li>
        </ul>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-5 border rounded-lg shadow-sm bg-gray-50 hover:shadow-md transition">
            ...
            <p className="text-yellow-500">★★★★★</p>
            <p className="text-sm text-gray-700 mt-2">Looking gorgeous.</p>
          </div>
          ...
          <div className="p-5 border rounded-lg shadow-sm bg-gray-50 hover:shadow-md transition">
            ...
            <p className="text-yellow-500">★★★★★</p>
            <p className="text-sm text-gray-700 mt-2">
              Safe packaging and delivery. The painting looks even better in
              real life!
            </p>
          </div>
        </div>
